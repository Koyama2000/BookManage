...
public class EsService {
     ...
     * @throws Exception
     */
    public void insertlist(List<Class> list,String indexName,String typeName) throws Exception {
        for (int i=0;i<list.size();i++){
            Index index=new Index.Builder(list.get(i)).index(indexName).type(typeName).build();
            try {
